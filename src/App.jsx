    ...
    <>
      ...
      <div className="flex justify-between items-center my-10 mx-20">
        ...
        <div className="flex gap-2">
          <button className="font-bold rounded-lg btn">Available</button>
          <button className="font-bold rounded-lg ">Selected(0)</button>
        </div>
      </div>

      <main className="">
        <AllPlayer players={players}></AllPlayer>
      </main>
          ...
          <div className="md:grid grid-cols-3 items-start gap-20 pb-4">
            ...
            <div>
              ...
              <div className=" mt-4">
                ...
                />
                <button className="bg bg-gradient-to-r from-orange-300 to bg-red-400 rounded-e-lg p-2 text-black font-bold">
                  Subscribe
                </button>
              </div>
            </div>
